...
#define WP_ALARM_BYPASS_SW_ON           (0x0001ul << 4)
#define WP_ALARM_PUMP_LONG_RUN          (0x0001ul << 5)
#define WP_ALARM_FREQUENT_START         (0x0001ul << 6)
#define WP_ALARM_FREQUENT_START_HIGH    (0x0001ul << 7)
